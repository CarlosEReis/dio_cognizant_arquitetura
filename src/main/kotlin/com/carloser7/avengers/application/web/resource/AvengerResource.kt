package com.carloser7.avengers.application.web.resource

import com.carloser7.avengers.application.web.resource.request.AvengerRequest
import com.carloser7.avengers.application.web.resource.response.AvengerResponse
...
class AvengerResource (
    ...
    @PutMapping("{id}")
    fun updateAvenger(@PathVariable("id") id: Long, @Valid @RequestBody avengerRequest: AvengerRequest) =
        repository.getDetail(id)?.let {
